...
bool CheckSequence(const CTransaction& txTo, const CBigNum& nSequence, unsigned int nIn) // TODO: SS remove it
{
    ...
    const uint64 nSequenceMasked = nSequence.getint() & nLockTimeMask;
...
bool CheckLockTime(const CTransaction& txTo, const CBigNum& nLockTime, unsigned int nIn) // TODO: SS remove it
{
    ...
    {
        printf("You can't use it untill nLockTime");
        return false;
    }
        ...
        while (pc < pend)
        {
            ...
            switch (opcode)
            {
                ...
                case OP_CHECKLOCKTIMEVERIFY:
                {
                    ...
                    if (!CheckLockTime(txTo, nLockTime, nIn))
                        return false;
                ...
                case OP_CHECKSEQUENCEVERIFY:
                {
                    ...
                    const CBigNum nSequence(stacktop(-1));
                    ...
                    if (!CheckSequence(txTo, nSequence, nIn))
                        return false;
