...
public:
    AsyncRPCOperation_shieldcoinbase(CTransaction contextualTx, std::vector<ShieldCoinbaseUTXO> inputs, std::string toAddress, CAmount fee = SHIELD_COINBASE_DEFAULT_MINERS_FEE, Value contextInfo = Value::null);
...
private:
    ...
    Value perform_joinsplit(ShieldCoinbaseJSInfo &);
...
public:
    ...
    Value perform_joinsplit(ShieldCoinbaseJSInfo &info) {
