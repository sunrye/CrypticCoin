...
private:
    ...
    Value perform_joinsplit(MergeToAddressJSInfo&);

    // JoinSplit with input notes to spend (JSOutPoints))
    Value perform_joinsplit(MergeToAddressJSInfo&, std::vector<JSOutPoint>&);
...
public:
    ...
    Value perform_joinsplit(MergeToAddressJSInfo& info)
    {
        return delegate->perform_joinsplit(info);
    }

    Value perform_joinsplit(MergeToAddressJSInfo& info, std::vector<JSOutPoint>& v)
    {
