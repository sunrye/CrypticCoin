...
static const uint256 hashGenesisBlockOfficial("0x0000010823705c132d5a3929933e5ca29882b00ed0d55a1d583a00ad0fa6bc67");
...
extern uint256 hashAnchor;
extern std::map<uint256, CAnchorsCacheEntry> anchorsMap;
extern std::map<uint256, CNullifiersCacheEntry> nullifiersMap;
...
public:
 ...
 //   bool ContextualCheckBlock(CBlockIndex * const pindexPrev);
    bool CheckBlock(libzcash::ProofVerifier& verifier, bool fCheckPOW=true, bool fCheckMerkleRoot=true, bool fCheckSig=true) const;
    bool AcceptBlock();
